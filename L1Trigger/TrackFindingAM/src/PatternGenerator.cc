...
PatternGenerator::PatternGenerator():
  ...
  m_stub(0), m_stub_modid(), m_stub_detid(), m_stub_pdg(), m_stub_strip(), m_stub_ptGEN(), m_stub_etaGEN(),
  p_m_stub_modid(NULL), p_m_stub_detid(NULL), p_m_stub_pdg(NULL),p_m_stub_strip(NULL),p_m_stub_ptGEN(NULL),p_m_stub_etaGEN(NULL)
{
}
...
void PatternGenerator::generate(SectorTree* sectors, int step, float threshold, map<int,pair<float,float> > eta_limits){
  ...
  TChain* tc = PatternGenerator::createTChain(particuleDirName, particuleDirName);
