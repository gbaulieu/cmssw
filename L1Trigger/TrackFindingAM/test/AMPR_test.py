...
process.source = cms.Source("PoolSource",
                            ...
                            fileNames = cms.untracked.vstring('file:PGun_example_TkOnly.root'), 
...
#process.TTPatternsFromStub.inputBankFile = cms.string('/afs/cern.ch/work/s/sviret/public/PatternBanks/Final_Legacy/620_SLHC7_MUBANK_lowmidhig_sec20_varDC_1048576.pbk')
process.TTPatternsFromStub.inputBankFile = cms.string('/data/viret/Bank_10_0_0/620_SLHC7_MUBANK_lowmidhig_sec19_varDC_1048576.pbk')
...
process.TTTrackAssociatorFromPixelDigis.TTTracks = cms.VInputTag( cms.InputTag("MergePROutput", "AML1Patterns"))

process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    splitLevel = cms.untracked.int32(0),
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    outputCommands = process.RAWSIMEventContent.outputCommands,
    fileName = cms.untracked.string('AM_output_32.root'),
