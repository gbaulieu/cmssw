...
process.source = cms.Source("PoolSource",
                            fileNames = cms.untracked.vstring('file:/data/viret/100X/ForAM/EDM_SLHC_extr_PU300_JETS_99.root'),
...
process.TTTrackAssociatorFromPixelDigis.TTTracks = cms.VInputTag( cms.InputTag("MergeTCOutput", "AML1TCfs"))


process.PatternFilter.applyCuts = cms.bool(False)   # Maximum number of stubs in a matched road
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('AMTC_output_filterOFF.root'),
