...
process.source = cms.Source("PoolSource",
                            fileNames = cms.untracked.vstring('file:/data/viret/AMProc/TMP_100_test_ele/RECOVERY/EDM_SLHC_extr_ELE_135_with_AMPR.root'),
#                            fileNames = cms.untracked.vstring('file:AM_output_32.root'),
...
process.MIBextraction.L1track_tag      = cms.InputTag( "MergePROutput", "AML1Patterns") # No L1Tracks
process.MIBextraction.L1tc_tag         = cms.InputTag( "MergePROutput", "AML1Patterns") # No TCs
